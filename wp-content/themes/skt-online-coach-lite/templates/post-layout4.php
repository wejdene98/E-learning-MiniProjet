<?php 
/**
 * Posts Layout 4 for SKT Online Coach Lite
 *
      ...
      <div class="lay4_inner">
        ...
        <div <?php post_class(); ?> id="post-<?php the_ID(); ?>"> 
          ...
          <div class="post_image"> 
            ...
            <div class="imgwrap"> <a href="<?php the_permalink();?>">
              <?php the_post_thumbnail('medium'); ?>
              </a></div>
            <?php elseif(!complete_gallery_thumb() == ''): ?>
            <div class="imgwrap">
              <div class="icon_wrap animated fadeInUp"> <a href="<?php the_permalink();?>" title="<?php echo _e('Read More','complete'); ?>"><i class="fa fa-plus"></i></a> </div>
            ...
            <div class="imgwrap"> <a href="<?php the_permalink();?>"><img alt="<?php the_title(); ?>" src="<?php echo complete_first_image(); ?>" /></a></div>
            <?php else : ?>
            <div class="imgwrap"> <a href="<?php the_permalink();?>"><img src="<?php echo complete_placeholder_image();?>" alt="<?php the_title_attribute(); ?>" class="complete_thumbnail"/></a></div>
            <?php endif; ?>
          </div>
          <!--POST THUMBNAIL END--> 
          ...
          <div class="post_content">
            <h2 class="postitle"><a href="<?php the_permalink();?>" title="<?php the_title_attribute(); ?>">
              <?php the_title(); ?>
              </a></h2>
            ...
            <div class="single_metainfo"> 
              ...
              <?php } else { ?>
              <div class="meta_comm">
                <?php comments_popup_link( __('0 Comment', 'complete'), __('1 Comment', 'complete'), __('% Comments', 'complete'), '', __('Off' , 'complete')); ?>
              </div>
              <?php } ?>
              <!--CATEGORY--> 
          ...
          <!--POST CONTENT END--> 
          <!--Read More Button-->
          <div class="blog_mo"><a href="<?php the_permalink();?>">+
            <?php _e('Read More', 'complete'); ?>
            </a></div>
        </div>
        <?php endwhile ?>
        <?php endif ?>
